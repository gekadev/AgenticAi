...
class GrokLLM:
    ...
    def get_llm_model(self):
        ...
        try:
            #get key 
            groq_api_key = self.user_controls_input['GEMINI_API_KEY']
            selected_groq_model = self.user_controls_input['selected_groq_model']
            if groq_api_key=='' and os.environ['GEMINI_API_KEY'] == '':
                st.error('Please Enter Your Groq api key')
            llm=ChatGoogleGenerativeAI(api_key=groq_api_key,model=selected_groq_model)
